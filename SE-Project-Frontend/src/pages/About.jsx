...
            <div>
              <img src='assets/self-reflection.gif' style={{ width: '64px', height: '64px' }} /> {/* Hero icon */}
...
          <img src='assets/idea.gif' style={{ width: '64px', height: '64px' }} /> {/* Story icon */}
          <h2>Our Story</h2>
...
            {values.map((value, index) => ( // Map over values array
              <div className="value-card" key={index}>
                <img src={value.logo} style={{ width: '64px', height: '64px' }} /> {/* Value icon */}
                <h3>{value.title}</h3>
...
            {teamMembers.map((member, index) => ( // Map over team members array
              <div className="team-member-card" key={index}>
                <img src={member.avatar} alt={`${member.name}`} className="team-member-avatar" /> {/* Member profile picture */}
                <h3>{member.name}</h3>
                <p>{member.role}</p>
              </div>
            ))}
